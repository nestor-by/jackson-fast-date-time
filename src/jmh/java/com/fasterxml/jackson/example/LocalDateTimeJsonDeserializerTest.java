...
/**
 * Unit tests for the `LocalDateTimeJsonDeserializer` class.
 * This class is responsible for deserializing JSON strings into `LocalDateTime` instances.
 */
public class LocalDateTimeJsonDeserializerTest {
  ...
  /**
   * Helper method to create an ObjectMapper configured with the LocalDateTimeJsonDeserializer.
   *
